...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
  ...
  <xsl:variable name="xslLib:els-common_xml.no-inclusions.available" select="true()" static="true"/>
  
  <!--Static compilation check for all inclusions to be available (avoid xslt mode not load)-->
  <xsl:variable name="xslLib:els-common_xml.no-inclusions.check-available-inclusions">
